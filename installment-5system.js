                ...
                if (!monthlyInst.isPaid) {
                    ...
                    if (diffDays === 0) {
                        ...
                        window.addNotificationItem({
                            ...
                            message: `القسط رقم ${monthlyInst.installmentNumber} من ${installment.title} للمستثمر ${installment.investorNamemessage: `القسط رقم ${monthlyInst.installmentNumber} من ${installment.title} للمستثمر ${installment.investorName} متأخر عن الدفع منذ ${Math.abs(diffDays)} يوم`,
                            type: 'danger',
                            date: new Date().toISOString(),
                            action: `openInstallmentDetails('${installment.id}')`,
                            category: 'installments'
